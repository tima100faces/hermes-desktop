...
/// "Project" / "Message") so `ChatMigrationService` can read old data
/// under its original shape before the live unified `Chat`/`Message`
/// models ever touch the default store.
///
